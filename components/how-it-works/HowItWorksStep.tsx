...
const HowItWorksStep = ({ step }: { step: Props }) => {
    ...
    return (
        <div className={cn(
            `flex flex-col gap-10 lg:items-center justify-center border border-[rgb(var(--border-default))] hover:border-[rgb(var(--border-hover))] transition-all duration-250 py-4 rounded-xl relative group`,
