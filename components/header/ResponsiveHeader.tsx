    ...
    return (
        <>
            <header className="fixed top-0 w-full z-50 bg-[rgb(var(--bg-surface-alpha))] border-b border-[rgb(var(--border-default))] backdrop-blur-xs">
                ...
                <div
                    className={`fixed top-0 right-0 min-h-screen w-[85vw] max-w-[380px] bg-[rgb(var(--bg-surface))] border-l border-[rgb(var(--border-default))] z-60 md:hidden transform transition-transform duration-300 ease-out ${mobileMenuOpen ? "translate-x-0" : "translate-x-full"
                        }`}
                >
            ...
            {/* Mobile Overlay */}
            <div
                className={`fixed inset-0 bg-black/50 backdrop-blur-lg z-40 md:hidden transition-opacity duration-300 ${mobileMenuOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"
                    }`}
                onClick={closeMobileMenu}
            />
        </>
